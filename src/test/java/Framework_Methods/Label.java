...
public class Label {
    ...
    public static boolean Verify_Label_Text_Equals(int rownumber, Page page, HashMap map, String reportLogFileName) throws IOException {
    ...
    public static boolean Verify_Label_Text_Equals_Ignore_Case(int rownumber, Page page, HashMap map, String reportLogFileName) throws IOException {
        boolean methodStatus = false;
        String headerName = "";
        String expectedHeaderName = map.get("CONTROL_VALUE").toString();
        Locator headerLocator = null;
    ...
    public static boolean Verify_Label_Text_Contains(int rownumber, Page page, HashMap map, String reportLogFileName) throws IOException {
        boolean methodStatus = false;
        String headerName = "";
        String expectedHeaderName = map.get("CONTROL_VALUE").toString();
        Locator headerLocator = null;
